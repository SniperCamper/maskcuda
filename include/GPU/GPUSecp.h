...
__device__ void _PointMultiSecp256k1(uint64_t* rx, uint64_t* ry, uint16_t* privKey, uint8_t* gTableX, uint8_t* gTableY, uint8_t* shared_gTableX = nullptr, uint8_t* shared_gTableY = nullptr);
